...
public:	// 静的メンバ関数
	// setter
	static void SetDevice(ID3D12Device* device) { ParticleManager3d::device = device; }
	static void SetCamera(Camera* camera) { ParticleManager3d::camera = camera; }
...
public:	// サブクラス
	...
	struct ConstBufferDataTransform {
		XMMATRIX viewProject;	// ビュープロジェクション行列
		XMMATRIX viewProjectBillboard;	// ビルボード行列
